...
기초가 기울면 그 위에 지은 건물을 아무리 잘 보수하더라도 흔들리고 기우는 것과 마찬가지 이치이다.  shoulder blade를 체간에 고정시켜주는 근육이 강해야, 상지와 어깨 근육이 강해질 수 있다. 이러한 면에서 어깨 통증에 대한 기능적 평가 및 접근을 고려할 수 있다.  
...
이전의 chronic rotator cuff injury로 인해 지금까지 어깨 통증으로 고통받고 있다면, 현재 시점에서 실제적 문제점은 rotator cuff injury가 아니라 S.I.C.K Scapula일 수 있다. 이런 면에서 다음 사항을 생각해 보자.      
